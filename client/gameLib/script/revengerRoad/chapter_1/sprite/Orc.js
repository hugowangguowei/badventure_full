...
define(function (require) {
    ...
    Orc.prototype.initialize = function(prop){
        var self = this;
        for(var i in prop){
            self[i] = prop[i];
        }
    ...
    Orc.prototype.refreshGeo = function(){
    ...
    Orc.prototype.removeFromGeo = function(){
        if(this.geoInfo.quaTreeNode){
            this.geoInfo.quaTreeNode.deleteSprite(this);
        }
    }
    Orc.prototype.action = function(){
        if(this.AI){
            this.viewHandle();
            this.moveHandle();
            this.attackHandle();
    ...
    Orc.prototype.moveHandle = function () {
        var self = this;
    ...
    Orc.prototype.attackHandle = function(){
        var self = this;
    ...
    Orc.prototype.isDead = function(){
        if(this.propInfo.life <= 0){
            return true;
        }
        return false;
    };
    Orc.prototype.isAttackable = function(beater){
        var self = this;
        var sLife = self.propInfo.life;
    ...
    Orc.prototype.getOutPut = function(){
