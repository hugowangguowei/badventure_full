...
define(function (require) {
    ...
    Knight.prototype.initialize = function(prop){
        var self = this;
        for(var i in prop){
            self[i] = prop[i];
        }
    ...
    Knight.prototype.refreshGeo = function(){
    ...
    Knight.prototype.removeFromGeo = function(){
        if(this.geoInfo.quaTreeNode){
            this.geoInfo.quaTreeNode.deleteSprite(this);
        }
    }
    Knight.prototype.action = function(){
        if(this.AI){
            this.viewHandle();
            this.moveHandle();
            this.attackHandle();
    ...
    Knight.prototype.viewHandle = function(){
        //view�¼������ж�
        var self = this;
    ...
    Knight.prototype.moveHandle = function () {
        var self = this;
    ...
    Knight.prototype.attackHandle = function(){
        var self = this;
    ...
    Knight.prototype.died = function(){
        if(!this.geoInfo.quaTreeNode){
            console.log("!!");
        }
    ...
    Knight.prototype.isDead = function(){
        if(this.propInfo.life <= 0){
            return true;
        }
        return false;
    };
    Knight.prototype.isAttackable = function(beater){
        var self = this;
        var sLife = self.propInfo.life;
    ...
    Knight.prototype.getOutPut = function(){
        //TODO ���ڵ�����ǲ���sprite Change��񶼻᷵��
        return{
            id:this.id,
            type:this.type,
            loc:this.loc,
