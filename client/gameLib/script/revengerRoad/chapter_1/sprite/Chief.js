...
define(function (require) {
    ...
    Chief.prototype.initialize = function(prop){
        var self = this;
        for(var i in prop){
            self[i] = prop[i];
        }
    };
    Chief.prototype.addToGeo = function(geo){
    ...
    Chief.prototype.refreshGeo = function(){
    ...
    Chief.prototype.removeFromGeo = function(){
        if(this.geoInfo.quaTreeNode){
            this.geoInfo.quaTreeNode.deleteSprite(this);
        }
    }
    Chief.prototype.action = function(){
        if(this.AI){
            this.viewHandle();
            this.moveHandle();
            this.attackHandle();
    ...
    Chief.prototype.viewHandle = function(){
        //view事件触发判断
        var self = this;
    ...
    Chief.prototype.moveHandle = function () {
        var self = this;
    ...
    Chief.prototype.attackHandle = function(){
        var self = this;
    ...
    Chief.prototype.isDead = function(){
        if(this.propInfo.life <= 0){
            return true;
        }
        return false;
    };
    Chief.prototype.isAttackable = function(beater){
        var self = this;
        var sLife = self.propInfo.life;
    ...
    Chief.prototype.getOutPut = function(){
