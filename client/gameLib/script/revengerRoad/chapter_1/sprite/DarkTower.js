...
define(function (require) {
    ...
    DarkTower.prototype.initialize = function(prop){
        var self = this;
        for(var i in prop){
            self[i] = prop[i];
        }
    ...
    DarkTower.prototype.refreshGeo = function(){
    ...
    DarkTower.prototype.removeFromGeo = function(){
        if(this.geoInfo.quaTreeNode){
            this.geoInfo.quaTreeNode.deleteSprite(this);
        }
    }
    ...
    DarkTower.prototype.viewHandle = function(){
        //view事件触发判断
        var self = this;
    ...
    DarkTower.prototype.moveHandle = function () {
        var self = this;
    ...
    DarkTower.prototype.attackHandle = function(){
        var self = this;
    ...
    DarkTower.prototype.died = function(){
        if(!this.geoInfo.quaTreeNode){
            console.log("!!");
        }
    ...
    DarkTower.prototype.isDead = function(){
        if(this.propInfo.life <= 0){
            return true;
        }
        return false;
    };
    DarkTower.prototype.isAttackable = function(beater){
        var self = this;
        var sLife = self.propInfo.life;
    ...
    DarkTower.prototype.getOutPut = function(){
